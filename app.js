...
app.use('/js/lib', express.static(path.join(__dirname, 'node_modules/mdbootstrap/js'), { maxAge: 31557600000 }));
app.use('/js/lib', express.static(path.join(__dirname, 'node_modules/jquery/dist'), { maxAge: 31557600000 }));
app.use('/font', express.static(path.join(__dirname, 'node_modules/mdbootstrap/font'), { maxAge: 31557600000 }));
